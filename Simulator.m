...
function Simulator()
	...
	% Initialize the Quadcopter State.
    state  = % TODO
    ...
    for i = 1:1000
        ...
        % Compute all state variables (Omega, Acceleration, Omegadot).
        state = % TODO
        state = % TODO
        state = % TODO
...
function state = setup_state()
    ...
    % Add some random theta disturbance
    %theta     = zeros(3, 1);   % roll pitch and yaw of the quadcopter.
    theta     = rand(3, 1);   % roll pitch and yaw of the quadcopter.
    
    thetadot  = zeros(3, 1);    % angular velocities of roll, pitch and yaw of the quadcopter.
    
    % Alternatively could add a thetadot disturbance
    %thetadot  = rand(3, 1);    % angular velocities of roll, pitch and yaw of the quadcopter. 
...
function state = setup_paint(state)
    ...
    Txyz = makehgtform('translate', state.x); % Translation matrix in space with respect x, y and z.
